...
MSG_HASH(
   ...
   "When enabled, forward Authorization on redirect.Disable this for some redirected download scenarios, like OpenList is configured with an object storage backend."
   )
MSG_HASH(
