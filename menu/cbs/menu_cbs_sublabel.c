...
DEFAULT_SUBLABEL_MACRO(action_bind_sublabel_cloud_sync_forward_authz,      MENU_ENUM_SUBLABEL_CLOUD_SYNC_FORWARD_AUTHZ)
      ...
      switch (cbs->enum_idx)
      {
        ...
        case MENU_ENUM_LABEL_PLAY_REPLAY:
         ...
         case MENU_ENUM_LABEL_CLOUD_SYNC_FORWARD_AUTHZ:
            BIND_ACTION_SUBLABEL(cbs, action_bind_sublabel_cloud_sync_forward_authz);
            break;
